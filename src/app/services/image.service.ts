...
export class ImageService {
  ...
  images: Image[] = [
    new Image('1', 'First image', 'First image description', 'https://angularbooks.com/img/angular4/img3.jpg', 'https://angularbooks.com/img/angular4/img3-l.jpg'),
    ...
    new Image('3', 'Third image', 'Third image description', 'https://angularbooks.com/img/angular4/img1.jpg', 'https://angularbooks.com/img/angular4/img1-l.jpg'),
    ...
    new Image('5', 'Suket Teki', 'Suket Teki description', 'https://angularbooks.com/img/angular4/img5.jpg', 'https://angularbooks.com/img/angular4/img5-l.jpg'),
